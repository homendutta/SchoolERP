...
/**
 * Student attendance — reads the unified attendance table scoped to Student
 * owners (daily / class / section / academic year).
 */
class StudentAttendanceController extends BaseController
{
    ...
    {
        $params = $request->all();
        $params['filter'] = array_merge((array) ($params['filter'] ?? []), ['owner_type' => Student::class]);
