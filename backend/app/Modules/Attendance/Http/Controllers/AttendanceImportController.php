...
/**
 * Attendance Import — Upload → Validate → Preview → Import → Summary, bound to
 * the 'attendance' importer (writes through the shared Attendance Engine).
 */
class AttendanceImportController extends BaseController
{
    private const KEY = 'attendance';
