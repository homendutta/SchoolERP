...
use App\Modules\HumanResources\Http\Requests\DepartmentRequest;
use App\Modules\HumanResources\Http\Resources\SimpleResource;
use App\Modules\HumanResources\Services\DepartmentService;
...
class DepartmentController extends BaseCrudController
{
    ...
    public function update(DepartmentRequest $request, int|string $id): JsonResponse
    {
