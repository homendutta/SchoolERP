/* Student Timeline — every important event, newest first. */
import { useEffect, useState } from 'react';
import { studentsApi, type TimelineEntry } from './api';
...
export function StudentTimelinePage() {
  ...
  useEffect(() => {
    ...
    studentsApi.timeline(Number(id)).then((e) => setEntries(Array.isArray(e) ? e : []));
  }, [id]);
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold text-[var(--navy-primary)]">Student Timeline</h2>
        </div>
